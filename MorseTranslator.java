 ...
 *
 * This is accomplished by running through an object containing an english to morse and morse to english translation sets - 
 *
 *
 *
 * NATHAN WOOD 
...
/* We need to translate english to morse code
 * I chose to use a massive decision tree to accomplish this
 * ex 
 * 			A
 *		       / \
 *		     ._   B 
...
public static String morseEnglish(String input){
	String morseEngOutput = "";

	return morseEngOutput;
	}
...
public static void main(String args[]){
	...
	// CREATE INFINITE LOOP TO PREVENT PROGRAM TERMINATION RIGHT AFTER USE !!! 
	while(true){
